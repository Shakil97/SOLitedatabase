package com.example.solitedatabase;
...
public class ContactsDB
{
    ...
    public static final String KET_CELL="_cell";


    public final String DATABASE_NAME="ContactsDB";
    public final String DATABASE_TABLE="ContactsTable";
    ...
    public String getData()
    {
        ...
        String [] columns=new String[] {KEY_ROWID,KEY_NAME,KET_CELL};
        ...
        int iCell=c.getColumnIndex(KET_CELL);
